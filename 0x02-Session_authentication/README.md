...
In the industry, you should not implement your own Session authentication system and use a module or framework that doing it for you (like in Python-Flask: [Flask-HTTPAuth](https://flask-httpauth.readthedocs.io/en/latest/)).
...
## [0. Et moi et moi et moi!](api/v1/app.py), [users.py](api/v1/views/users.py)
...
## [1. Empty session](api/v1/auth/session_auth.py), [app.py](api/v1/app.py)
...
## [7. New view for Session Authentication](api/v1/views/session_auth.py), [__init__.py](api/v1/views/__init__.py)
...
## [8. Logout](api/v1/auth/session_auth.py), [session_auth.py](api/v1/views/session_auth.py)
